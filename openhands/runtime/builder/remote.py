...
class RemoteRuntimeBuilder(RuntimeBuilder):
    ...
    def build(
        ...
        files.append(
            (
                'use_cache',
                (None, os.environ.get('OPENHANDS_DOCKER_CACHE', '')),
            )
        )
        ...
        # set again once you build
        self.api_url = build_data['url']
    ...
    def image_exists(self, image_name: str, pull_from_repo: bool = True) -> bool:
        ...
        # make note of the URL sent by the server for future requests
        self.api_url = result['url']
